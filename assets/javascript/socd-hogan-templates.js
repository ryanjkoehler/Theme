...
this["Templates"]["notifications--message"] = new Hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<p class=\"notifications-message notifications-message__");_.b(_.v(_.f("tone",c,p,0)));_.b("\">");_.b(_.v(_.f("message",c,p,0)));_.b("</p> ");return _.fl();;});