		...
		<div class="gw">
		 ...
		 --><div class="col lap--one-half push--desk--one-sixth desk--one-third beta--box">
				<div class="cell">
					...
					<p>The site is currently under <a href="http://make.socd.io">active development</a>. If you should encounter any bugs them please let us know via the <a href="<?php socd_beta_link(); ?>">&beta;</a> tab.</p>
